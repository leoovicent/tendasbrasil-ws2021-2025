...
<?php
	$params_pagetitle = array(
		...
		'subtitulo' => 'Tendas Brasil • Trabalhe Conosco'
	);
  ...
  <div class="container padding-40px-tb lg-padding-20px-tb md-no-padding-tb">
    <div class="row justify-content-center">
			<div class="col-11 col-md-10 col-lg-9 col-xl-8 text-center">
				...
				<h1 class="header4 margin-10px-bottom wow fadeIn" data-wow-delay="1.0s">Faça parte da nossa equipe</h1>
				...
				<div class="wow fadeIn" data-wow-delay="1.6s">
					<?php echo do_shortcode('[contact-form-7 id="35f81f8" title="Trabalhe Conosco"]'); ?>
				</div>
			</div>
		</div>
	</div>
